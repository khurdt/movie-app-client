                                    ...
                                    if (
                                        ...
                                        return (
                                            <Card key={movie._id} className='m-1 little-card' style={{ backgroundColor: '#1E2127', color: 'white', }}>
                                                <Card.Img className='m-1' style={{ maxWidth: '140px', height: '207px' }} src={movie.imagePath} crossOrigin='anonymous' />
                                                <Card.Text style={{ fontSize: '12px' }} className='m-1' >{movie.title}</Card.Text>
                                                <Trash style={{ cursor: 'pointer' }} className='mx-auto my-1' color='red' value={movie._id} onClick={(e) => removeFavorite(e, movie)} />
                                            </Card>
                                        )
                                    }
                                })}
